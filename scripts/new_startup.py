...
if __name__ == "__main__":
    ...
    working_dir = "/Users/sangeethasampathkumar/Desktop/ds_p1/grpcDemo/classes/artifacts/grpcDemo_jar/"
...
#    subprocess.check_call(mvn_install_list, cwd = working_dir)
    ...
    command = "java -jar " + working_dir + "grpcDemo.jar"
    ...
    for i in range(int(n)):
        ...
        argString = command + " " + n + " " + str(rank) + " " + update_node + " " + base_port
        #shell_command = (" ".join(mvn_install_list)) + " " + argString
        #subprocess.check_call(mvn_build_list, cwd = working_dir)
        #subprocess.check_call(mvn_install_list, cwd = working_dir)
        command_list.append(argString)
